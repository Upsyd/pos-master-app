...
public class AccountAnalyticAccount extends OModel {
    ...
    public static final String AUTHORITY = "com.bi.pos.core.provider.content.sync.account_analytic_account";

    OColumn balance = new OColumn("Balance", OFloat.class);
    OColumn child_complete_ids = new OColumn("Account Hierarchy", AccountAnalyticAccount.class,OColumn.RelationType.ManyToMany);
    OColumn child_ids = new OColumn("Child Accounts",AccountAnalyticAccount.class,OColumn.RelationType.OneToMany);
    ...
    OColumn line_ids = new OColumn("Analytic Entries", AccountAnalyticLine.class, OColumn.RelationType.OneToMany);
    ...
    OColumn parent_id = new OColumn("Parent Analytic Account", AccountAnalyticAccount.class, OColumn.RelationType.ManyToOne);
    ...
    OColumn template_id = new OColumn("Template of Contract", AccountAnalyticAccount.class, OColumn.RelationType.ManyToOne);
