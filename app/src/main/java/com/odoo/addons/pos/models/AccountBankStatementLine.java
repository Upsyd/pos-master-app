...
public class AccountBankStatementLine extends OModel {
    ...
    //OColumn account_id = new OColumn("Account", Account.Account.class,OColumn.RelationType.ManyToOne);
    ...
    //OColumn journal_id = new OColumn("Journal", AccountJournales.class,OColumn.RelationType.ManyToOne);
