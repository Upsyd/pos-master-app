 ...
 */
public class AccountAnalyticJournal extends OModel {
    public static final String TAG =AccountAnalyticJournal.class.getSimpleName();
    ...
    OColumn line_ids = new OColumn("Lines",AccountAnalyticLine.class, OColumn.RelationType.OneToMany);
    ...
    public AccountAnalyticJournal(Context context, OUser user) {
