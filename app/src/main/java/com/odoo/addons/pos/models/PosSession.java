...
public class PosSession extends OModel {
    ...
    OColumn cash_journal_id = new OColumn("Cash Journal", AccountJournal.class, OColumn.RelationType.ManyToOne);
    ...
    OColumn case_regisgter_id = new OColumn("Cash Register", AccountBankStatement.class, OColumn.RelationType.ManyToOne);
    ...
    OColumn statement_ids = new OColumn("BankStatement", AccountBankStatement.class, OColumn.RelationType.OneToMany);
